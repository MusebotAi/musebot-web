...
<template>
  <div class="modal">
    <div class="content form pall40" v-if="step === 'form'">
      <div class="ctitle">Describe a scene</div>
      <el-input
        type="textarea"
        placeholder="Text example: a portrait of half Spider-Man’s mask and half Deadpools mask vertically "
        class="input"
        :rows="4"
        v-model="value"
      />
    ...
    <div class="content w331 pl22 pr22 pt70 pb70" v-if="step === 'genimg'">
      <div class="ctitle">AI is generating images……</div>
      <div class="ctitle">Just wait.</div>

      <div class="per mt30 fs20">{{ percent }}%</div>
      <div class="process-bar mt20">
        <div class="inner" :style="`width: ${percent}%;`"></div>
      </div>
    </div>

    <div class="content pt60 pl30 pr30 pb40" v-if="step === 'doneimg'">
      <div class="flex-a-j">
    ...
    >
      ...
      <div class="success fs14" v-if="success">
        <div>Congrats!</div>
